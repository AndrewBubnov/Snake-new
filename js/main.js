...
//**********************************************************************************************************
    let tail = moves.concat(steps);
    let tempStone = steps.slice(steps.length - snakeLength + 1);
    ...
    if (snakeLength > 1 && tempSearch[0].x === -1 && tempSearch[0].y === -1){
        ...
        steps = bfs(start, finish, tempStone);
    }

    else if (steps[0].x === - 1 && steps[0].y === - 1){
...
//***********************************************************************************************************
    ...
    interval = setInterval(function () {
        ...
        //     return nextStep.x === element.x && nextStep.y === element.y;
        // });
        //
        // if (closed){
        //     console.log("closed");
